import os import json import requests from flask import Flask, request, jsonify, send_file
...
DEFAULT_MODEL = "deepseek/deepseek-chat-v3-0324:free" MAX_DOTS_MODEL = "openrouter/cypher-alpha:free"
